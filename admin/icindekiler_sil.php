...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = $conn->prepare("SELECT * FROM icindekiler WHERE dil = :dil");
    ...
    if (isset($_POST['submit'])) {
        $id = $_POST['id'];
        $sql = $conn->prepare("DELETE FROM icindekiler WHERE id = :id");
    ...
    if (isset($_POST['guncelle'])) {
        $dil = $_POST['dil'];
        $id = $_POST['id'];
        header("Location:icindekiler_guncelle.php?id=$id&dil=$dil");
        exit();
    }
}
                                ...
                                <div class="content-wrapper">
                                    ...
                                    <div class="content-header">
                                        <div class="container-fluid">
                                            <div class="row mb-2">
                                                <div class="col-sm-6">
                                                    <h1 class="m-0">İçindekiler Sil</h1>
                                                </div><!-- /.col -->
                                            </div><!-- /.row -->
                                        </div><!-- /.container-fluid -->
                                    </div>
                                                        ...
                                                        <?php foreach ($contents as $head) { ?>
                                                            ...
                                                            <form role="form" action="" method="POST" enctype="multipart/form-data" style="width: 100%; align-items: center; flex-direction: column; display: flex;">
                                                                <div class="col-md-12 mb-3" style="display: flex; flex-direction: column; align-items: center;">
                                                                    <img src="../assets/img/<?php echo $head['image']; ?>" width="50%" alt="">
                                                                    <h5 style="margin-top: 15px;"><?php echo $head['name']; ?></h5>
                                                                </div>
                                                                ...
                                                                <div class="row d-flex justify-content-end mr-3" style="width: 50%;">
                                                                    <input type="submit" name="guncelle" class="btn btn-warning" value="Güncelle">
                                                                </div>
                                                                <div class="row d-flex justify-content-end mr-3" style="width: 50%;">
