...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['kategori'])) {
        if (isset($_POST['kategori']) && !empty($_POST['kategori'])) {
            $title = nl2br($_POST['kategori']);

            $sql = $conn->prepare("INSERT INTO kategoriler (title, dil) VALUES (:title, :dil)");
                                ...
                                <div class="content-wrapper">
                                    ...
                                    <div class="content-header">
                                        <div class="container-fluid">
                                            <div class="row mb-2">
                                                <div class="col-sm-6">
                                                    <h1 class="m-0">Ürün Kategori Ekle</h1>
                                                </div><!-- /.col -->
                                            </div><!-- /.row -->
                                        </div><!-- /.container-fluid -->
                                    </div>
                                                    ...
                                                    <?php if ($aktif == 1) { ?>
                                                        <form role="form" action="" method="POST" enctype="multipart/form-data">
                                                            <div class="col-md-12 mb-3">
                                                                <label for="kategori" class="form-label fw-bold">Kategori Adı:</label>
