...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['submit'])) {
        $id = $_POST['id'];
        $sql = $conn->prepare("DELETE FROM kategoriler WHERE id = :id");
    ...
    if (isset($_POST['guncelle'])) {
        $dil = $_POST['dil'];
        $id = $_POST['id'];
        header("Location:kategori_guncelle.php?id=$id&dil=$dil");
        exit();
    }
}
                                                    ...
                                                    <?php if ($aktif == 1) { ?>
                                                        <div style="display: flex; flex-wrap: wrap; justify-content: center;">
                                                            <?php foreach ($contents as $head) { ?>
                                                                <form role="form" action="" method="POST" enctype="multipart/form-data" style="    flex-direction: column;
    display: flex;
    justify-content: center;
    text-align: center;
